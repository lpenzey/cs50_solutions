...
function addMarker(place)
{
 // retrieve latitude and longitude
    ...
    // marker icon link
    let image = "http://maps.google.com/mapfiles/kml/pal2/icon13.png";
    ...
    // retrieve articles for place
    $.getJSON("/articles", {geo: place.postal_code}, function(articles) {

        // Only display article window if articles exist
		...
		// listen for click events on marker
